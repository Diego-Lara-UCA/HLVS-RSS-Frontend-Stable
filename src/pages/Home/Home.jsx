    ...
    <div>
      <header>
        ...
        <div className="flex flex-col px-8 h-[100vh] justify-center 2xl:px-36 2xl:m-auto bg-gradient-to-tr from-zinc-700 to-zinc-900 ">
          <h1 className="text-4xl text-center mb-8 font-bold 2xl:text-left 2xl:text-7xl text-white ">
            Residential <br /> Security System
          </h1>
          <h2 className="font-light text-center mb-10 2xl:text-start 2xl:text-xl text-white">
